...
func InitSystemProbeConfig(cfg Config) {
	...
	cfg.BindEnvAndSetDefault("runtime_security_config.activity_dump.max_dump_size", 4500)
	...
	cfg.BindEnvAndSetDefault("runtime_security_config.activity_dump.cgroup_dump_timeout", 10)
	cfg.BindEnvAndSetDefault("runtime_security_config.activity_dump.rate_limiter", 500)
	cfg.BindEnvAndSetDefault("runtime_security_config.activity_dump.cgroup_wait_list_timeout", 50000)
	...
	cfg.BindEnvAndSetDefault("runtime_security_config.activity_dump.max_dump_count_per_workload", 1)
